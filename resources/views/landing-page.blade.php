...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Commission calculation service</title>
...
<div class="col-md-8"><h2>Commission calculation service</h2>
</div>
</div>
<br>
<div class="row">
...
<div class="col-md-6">
    ...
    <div class="alert alert-danger">
        <ul>
          @foreach (\Request::get('errors') as $errors)
              {{ $errors }}
          @endforeach
        </ul>
    </div>
...
<div class="form-group">
    <a target="_blank" href="{{ route('output') }}"><button type="button" class="text-success btn">Calculation with latest uploaded file</button></a>
